...
import com.cytech.myakka.registery.{RoomRegistry, ServerRegistry, UserServerRegistry, UserRegistry, PrivateChatRegistry}
import com.cytech.myakka.routes.{RoomRoutes, ServerRoutes, UserRoutes, UserServerRoutes, PrivateChatRoutes} // Updated import
...
object QuickstartApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val rootBehavior = Behaviors.setup[Nothing] { context =>
      ...
      // Combine all routes
      val combinedRoutes: Route = userRoutes.userRoutes ~ roomRoutes.roomRoutes ~ serverRoutes.serverRoutes ~ userServerRoutes.userServerRoutes ~ privateChatRoutes.privateChatRoutes
